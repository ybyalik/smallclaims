...
export const AUTO_HUB: CategoryHubData = {
  ...
  issues: [
    ...
    { slug: "towing-damage", title: "Towing company damaged my car", blurb: "Tow truck scratched, dented, or broke parts of your car. The towing company is a bailee and held to a higher standard than ordinary negligence.", icon: <Truck size={24} strokeWidth={1.7} />, ready: true },
    ...
    { slug: "valet-damage", title: "Valet damaged my car", blurb: "The valet operates as a bailee. Bailment law presumes negligence when the car comes back damaged. The valet has to prove they were not at fault.", icon: <KeyRound size={24} strokeWidth={1.7} />, ready: true },
    { slug: "lemon-car", title: "Sold me a lemon", blurb: "Recurring defect the manufacturer cannot fix. Federal Magnuson-Moss + state lemon laws + BBB Auto Line arbitration. Refund or replacement.", icon: <Citrus size={24} strokeWidth={1.7} />, ready: true },
  ],
  ...
  belongs: {
    ...
    inItems: [
      { titleBold: "Mechanic overcharges and bad work.", rest: "State auto repair laws cap charges over estimate without consent." },
      { titleBold: "Towing damage.", rest: "Tow companies are bailees; presumption of negligence applies." },
      { titleBold: "Valet damage.", rest: "Bailment law gives drivers a strong presumption of negligence claim." },
      { titleBold: "Parked-car hit (uninsured driver).", rest: "When insurance does not cover or claim is rejected." },
      { titleBold: "Dealership fraud and undisclosed damage.", rest: "Many state UDAP statutes add 2x or 3x damages plus fees." },
    ],
    outItems: [
