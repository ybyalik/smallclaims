...
export const NEIGHBOR_HUB: CategoryHubData = {
  ...
  issues: [
    { slug: "property-damage", title: "Property damage", blurb: "Their tree, fence, or other property damaged yours. Most cases get paid through the neighbor's homeowners insurance. Small claims is the backup when insurance won't pay.", icon: <Home size={24} strokeWidth={1.7} />, ready: true },
    { slug: "dead-tree-fell", title: "Dead tree fell on house", blurb: "If your neighbor knew the tree was dead or dangerous and didn't deal with it, they're on the hook for the damage. An arborist's report is what wins the case.", icon: <TreeDeciduous size={24} strokeWidth={1.7} />, ready: true },
    { slug: "tree-encroachment", title: "Tree damage and encroachment", blurb: "Branches and roots from their tree damaging your property. You can trim branches yourself up to the property line, and sue for any actual damage.", icon: <TreePine size={24} strokeWidth={1.7} />, ready: true },
    { slug: "noise", title: "Noise nuisance", blurb: "Late-night music, parties, dog barking. Build the case with: decibel logs, copies of city noise ordinances, police-call records. You can sue for soundproofing costs and more.", icon: <Volume2 size={24} strokeWidth={1.7} />, ready: true },
    { slug: "harassment", title: "Harassment", blurb: "Threats, stalking, repeated trespass. You can get both a civil restraining order and money damages. A documented pattern of incidents is the whole case.", icon: <AlertOctagon size={24} strokeWidth={1.7} />, ready: true },
    { slug: "water-runoff", title: "Water runoff flooding", blurb: "Your state has rules about where neighbors can direct water. An engineer's report identifying the source is key. You can recover drainage repair plus mold remediation.", icon: <Droplets size={24} strokeWidth={1.7} />, ready: true },
    { slug: "fence-dispute", title: "Fence dispute", blurb: "Most states require neighbors to share the cost of maintaining a boundary fence equally (in California, that's Civil Code § 841). If the neighbor damaged the fence through negligence, you can recover the full repair cost.", icon: <Fence size={24} strokeWidth={1.7} />, ready: true },
    { slug: "blocking-driveway", title: "Blocking driveway", blurb: "When someone repeatedly blocks your driveway, you can tow first, then sue. You can recover both the towing costs and any lost wages from missed work.", icon: <ParkingSquare size={24} strokeWidth={1.7} />, ready: true },
    { slug: "construction-damage", title: "Construction damage", blurb: "Damage from a neighbor's construction project. The contractor's liability insurance is your primary path to recovery. Both the contractor AND the neighbor are usually on the hook.", icon: <Construction size={24} strokeWidth={1.7} />, ready: true },
    { slug: "smoke-and-odors", title: "Smoke and odors", blurb: "Cigar smoke, marijuana, BBQ smoke, chemical odors that drift into your home. You can sue under 'nuisance' law and your city's air-quality ordinances. Recover any mitigation costs and medical bills.", icon: <Wind size={24} strokeWidth={1.7} />, ready: true },
  ],
  ...
  belongs: {
    ...
    inItems: [
      { titleBold: "Property damage from negligence.", rest: "Their tree fell, their pipe burst, their kid threw a rock. Standard homeowners insurance covers this." },
      { titleBold: "Repair of a shared fence.", rest: "In most states, neighbors must split the cost of maintaining a boundary fence equally." },
      { titleBold: "Water runoff and drainage damage.", rest: "Regraded land that floods your yard. You can recover both repair costs and what you spent to prevent further damage." },
      { titleBold: "Noise nuisance with a documented pattern.", rest: "Decibel logs, police-call records, and city-ordinance citations support recovery for soundproofing costs." },
      { titleBold: "Towing costs and lost wages.", rest: "When a neighbor blocks your driveway or misuses a shared lot. Recover both the tow cost and the time you missed at work." },
    ],
    outItems: [
      { titleBold: "Fixing the boundary line itself.", rest: "If you're trying to legally redraw where one property ends and another begins (called a 'quiet title' action), that goes to regular civil court — not small claims." },
      { titleBold: "Forcing a neighbor to stop or do something.", rest: "If you need a court order making them act or stop (an 'injunction'), small claims usually can't issue those. You'd file in regular civil court." },
      { titleBold: "Personal injury claims.", rest: "Cases involving medical bills from an injury usually outgrow small claims — talk to a personal-injury attorney about regular civil court." },
      { titleBold: "HOA bylaw disputes.", rest: "Your HOA's internal complaint or arbitration process comes first. Some states require that before any lawsuit." },
    ],
  },
  ...
  faqs: [
    ...
    { q: "How long do I have to sue?", a: "Property damage and negligence claims usually give you 2 to 4 years to file. Nuisance claims (noise, smoke, harassment) often have shorter windows (1 to 3 years). If the problem is ongoing (flooding that keeps happening, harassment that keeps recurring), the clock resets with each new incident — you don't get cut off because the first event was long ago." },
  ],
