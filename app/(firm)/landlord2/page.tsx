...
export const metadata: Metadata = {
  ...
  description: "Same landlord4 with the home4-wide treatment: 1600px container, /home2 typography, white bg with cream alternates, peach accent on dark.",
  alternates: { canonical: "/landlord2" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 36 }}>
              <FirmBtn href="/case-score2">Check My Case (Free)</FirmBtn>
              <FirmBtn kind="ghost" href="/demand-letter2">Send a Demand Letter</FirmBtn>
            </div>
        ...
        <article style={{ background: C.cream, border: `1px solid ${C.line}`, borderRadius: RAD.large, padding: "32px 40px" }}>
          ...
          <div style={{ background: "#fff", borderRadius: RAD.panel, padding: "10px 8px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 }}>
              {[
                { Icon: Wallet, t: "Security deposit not returned", d: "Most common case. 2× or 3× penalty in many states.", href: "/small-claims2/landlord/security-deposit" },
                { Icon: Droplet, t: "Mold and habitability", d: "Medical costs, ruined property, rent abatement.", href: "/small-claims2/landlord/mold" },
                { Icon: DoorOpen, t: "Wrongful eviction", d: "Moving costs, lost property, hotel stays, statutory damages.", href: "/small-claims2/landlord/wrongful-eviction" },
                { Icon: Lock, t: "Illegal lockout", d: "Changed locks, shut-off utilities. CA $100/day, FL 3× damages.", href: "/small-claims2/landlord/illegal-lockout" },
                { Icon: ShieldAlert, t: "Landlord harassment", d: "Unauthorized entries, threats, retaliation. CA $2K/act, NYC 3× rent.", href: "/small-claims2/landlord/harassment" },
                { Icon: Bug, t: "Pest infestation", d: "Roaches, bed bugs, rats. Treatment costs and rent reduction.", href: "/small-claims2/landlord/pest-infestation" },
                { Icon: Zap, t: "Unsafe living conditions", d: "Structural, electrical, no heat or hot water.", href: "/small-claims2/landlord/unsafe-conditions" },
                { Icon: HeartCrack, t: "Emotional distress", d: "Pair with a willful tenant claim. Documented damages awarded.", href: "/small-claims2/landlord/emotional-distress" },
                { Icon: Building2, t: "Apartment complex", d: "Corporate landlords settle faster. Typically $4K to $12K.", href: "/small-claims2/landlord/apartment-complex" },
                { Icon: LogOut, t: "After moving out", d: "Most states honor 1 to 4 years after move-out. Move quickly anyway.", href: "/small-claims2/landlord/after-moving-out" },
                { Icon: FileX, t: "Break your lease", d: "Five legal grounds: military, DV, habitability, harassment, mutual.", href: "/small-claims2/landlord/break-lease" },
                { Icon: HelpCircle, t: "Something else?", d: "Tell us about your situation in 90 seconds.", href: "/case-score2" },
              ].map((it, idx) => (
      ...
      <section style={{ padding: `120px ${PAD_X}` }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 60, alignItems: "center" }}>
          <div>
            ...
            <div style={{ marginTop: 32 }}><FirmBtn kind="ghost" href="/small-claims2">See all 50 state guides</FirmBtn></div>
          </div>
          <div>
