...
import { collectionPageSchema, breadcrumbList, jsonLdGraph } from "../../../lib/schema";
import {
...
export const metadata: Metadata = {
  ...
  description:
    "Same small-claims4 with the home4-wide treatment: 1600px container, / typography, white bg with cream alternates, peach accent on dark.",
...
export default async function SmallClaims2() {
  ...
  const jsonLd = jsonLdGraph(
    collectionPageSchema({
      ...
      url: "/small-claims",
      items: [
        { name: "Landlord disputes", url: "/small-claims/landlord" },
        { name: "Contractor disputes", url: "/small-claims/contractor" },
        { name: "Employer disputes", url: "/small-claims/employer" },
        { name: "Auto disputes", url: "/small-claims/auto" },
        { name: "Neighbor disputes", url: "/small-claims/neighbor" },
        { name: "Personal loan disputes", url: "/small-claims/personal-loan" },
        { name: "Roommate disputes", url: "/small-claims/roommate" },
        { name: "Online seller disputes", url: "/small-claims/online-seller" },
        { name: "Refund disputes", url: "/small-claims/refund" },
      ],
    }),
    breadcrumbList([
      { name: "CivilCase", url: "/" },
        ...
        <article style={{ background: C.cream, border: `1px solid ${C.line}`, borderRadius: RAD.large, padding: "32px 40px" }}>
          ...
          <div style={{ background: "#fff", borderRadius: RAD.panel, padding: "10px 8px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 }}>
              {[
                { Icon: Building2, t: "Sue a landlord", d: "Security deposit, mold, eviction, lockout", href: "/small-claims/landlord" },
                { Icon: Briefcase, t: "Sue an employer", d: "Wrongful termination, unpaid wages, retaliation", href: "/small-claims/employer" },
                { Icon: Hammer, t: "Sue a contractor", d: "Took deposit, unfinished work, defective", href: "/small-claims/contractor" },
                { Icon: Car, t: "Sue over a car", d: "Parked-car hit, lemon, mechanic, towing", href: "/small-claims/auto" },
                { Icon: Trees, t: "Sue a neighbor", d: "Property damage, trees, noise, fence", href: "/small-claims/neighbor" },
                { Icon: HandCoins, t: "Recover money owed", d: "Friends, family, IOUs, verbal agreements", href: "/small-claims/personal-loan" },
                { Icon: Users, t: "Sue a roommate", d: "Unpaid rent, bills, move-out damage", href: "/small-claims/roommate" },
                { Icon: ShoppingBag, t: "Sue an online seller", d: "Amazon, eBay, Marketplace, Venmo scams", href: "/small-claims/online-seller" },
                { Icon: Receipt, t: "Get a refund", d: "Defective products, services, subscriptions", href: "/small-claims/refund" },
                { Icon: FileText, t: "More categories", d: "View all dispute guides", href: "/small-claims" },
              ].map((it, idx) => (
      ...
      <section style={{ padding: `100px ${PAD_X}`, background: C.cream, color: C.fg }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 22, flexWrap: "wrap" }}>
            {[
              { label: "Sue over a car", href: "/small-claims/auto" },
