...
import { articleSchema, breadcrumbList, jsonLdGraph } from "../../../../lib/schema";
import {
      ...
      <section style={{ padding: `40px ${PAD_X} 120px` }}>
        <div style={{ background: C.cream, padding: "60px 56px", borderRadius: RAD.panel, display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 60, alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "flex-end", flexWrap: "wrap" }}>
            <Link href="/blog" style={{ textDecoration: "none" }}><FirmBtn kind="ghost">← All posts</FirmBtn></Link>
            <Link href="/demand-letter" style={{ textDecoration: "none" }}><FirmBtn>Send a Demand Letter</FirmBtn></Link>
          </div>
        </div>
      </section>
    </main>
