...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/collection-plan2" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.05fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 36 }}>
              <FirmBtn href="/collection-plan2">Get My Collection Plan</FirmBtn>
              <FirmBtn kind="ghost" href="/collection-plan2">See a sample plan</FirmBtn>
            </div>
        ...
        <div style={{ background: C.dark, color: "#fff", padding: "36px 36px", borderRadius: RAD.panel, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <FirmBtn kind="accent" href="/collection-plan2">Start My Collection Plan</FirmBtn>
