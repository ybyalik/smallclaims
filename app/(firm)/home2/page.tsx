...
export const metadata: Metadata = {
  ...
  description:
    "Same Hybrid structure as /home4 but with /home2's typography spec (weight 600, clamp sizes, 0.14em eyebrows, plain ink italic emphasis) and the 1600px container used by the other wide variants.",
      ...
      {[
        {
          ...
          href: "/small-claims2/landlord/security-deposit",
          reverse: false,
        },
        {
          n: "II.",
          ...
          href: "/small-claims2/landlord/illegal-lockout",
          reverse: true,
        },
      ].map((s, idx) => {
        const copyBlock = (
