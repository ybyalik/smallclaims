        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 36 }}>
              ...
              <FirmBtn kind="ghost" href="/small-claims">Browse State Guides</FirmBtn>
            </div>
          </div>
          {/* Inbox mockup */}
      ...
      <section style={{ padding: `120px ${PAD_X}` }}>
        <div style={{ background: C.dark, color: "#fff", padding: "80px 56px", borderRadius: RAD.panel, textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", marginTop: 32 }}>
            <FirmBtn kind="accent" href="/demand-letter">Send a Demand Letter</FirmBtn>
            <FirmBtn kind="ghostDark" href="/small-claims">Browse State Guides</FirmBtn>
          </div>
        </div>
      </section>
    </main>
