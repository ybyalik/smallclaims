...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/demand-letter2" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.05fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 36 }}>
              <FirmBtn href="/demand-letter2">Start my letter</FirmBtn>
              <FirmBtn kind="ghost" href="/demand-letter2">See a sample letter</FirmBtn>
            </div>
        ...
        <div style={{ background: C.dark, color: "#fff", padding: "36px 36px", borderRadius: RAD.panel, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <FirmBtn kind="accent" href="/demand-letter2">Start Your Letter</FirmBtn>
          ...
          {[
            ...
            return (
              <div key={p.name} style={{ padding: 40, background: bg, color: fg, border: p.popular ? "none" : `1px solid ${C.line}`, borderRadius: RAD.panel, position: "relative" }}>
                ...
                <button type="button" style={{ width: "100%", background: p.popular ? "#3D7A4A" : C.dark, color: p.popular ? "#fef9f1" : "#fff", border: "none", padding: 16, font: `600 14px/1 ${BODY_FONT}`, cursor: "pointer", borderRadius: 999, display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
