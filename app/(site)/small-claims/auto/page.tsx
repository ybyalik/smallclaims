        ...
        <section className="cat-section">
          ...
          <div className="photo-grid">
            {ISSUES.map((i, idx) => {
              ...
              return i.ready ? (
                <Link key={i.slug} href={`/small-claims/sue-auto-${i.slug}`} className="photo-card">
                  {inner}
                </Link>
              ) : (
        ...
        <section className="cat-section">
          ...
          <div className="cat-recovery">
            ...
            <div className="cat-recovery-total">
              ...
              <div className="cat-recovery-total-num">$3,800</div>
            </div>
          </div>
        </section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.85fr 1fr", gap: 0, alignItems: "center" }}>
              ...
              <div style={{ borderLeft: "1px solid #1f1f1f", padding: "20px 44px", position: "relative", alignSelf: "stretch", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                ...
                <p style={{ fontFamily: "Newsreader, Georgia, serif", fontSize: 18, fontStyle: "italic", lineHeight: 1.35, letterSpacing: "-0.005em", color: "#fef9f1", margin: "0 0 16px" }}>
                  Dealership hid frame damage on a used car. Court ordered $3,500 plus my filing fee back.
                </p>
                <div>
                  <div style={{ fontFamily: "Geist, system-ui, sans-serif", fontWeight: 700, fontSize: 14, color: "#fff", marginBottom: 2 }}>Carlos M.</div>
                  <div style={{ fontSize: 12.5, color: "#9aa0a6" }}>Buyer · Arizona</div>
                </div>
              </div>
            </div>
          </div>
