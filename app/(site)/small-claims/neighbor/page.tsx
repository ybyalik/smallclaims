...
const ISSUE_PHOTOS = ["1568605114967-8130f3a36994", "1560518883-ce09059eeffa", "1502672260266-1c1ef2d93688", "1493809842364-78817add7ffb", "1556909114-f6e7ad7d3136"];
        ...
        <section className="cat-section">
          ...
          <div className="cat-recovery">
            <div className="cat-recovery-rows">
              <div className="cat-recovery-row"><span className="cat-recovery-icon" aria-hidden="true"><svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h12v17l-3-2-3 2-3-2-3 2z" /><path d="M12 8v6M10 9.5c0-.8.7-1.5 1.5-1.5h1c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5h-1c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5h1c.8 0 1.5-.7 1.5-1.5" /></svg></span><span className="cat-recovery-num" aria-hidden="true">01</span><div className="cat-recovery-label"><span className="cat-recovery-tag">Direct damages</span><p>Repair cost, replaced belongings, mitigation (soundproofing, drainage).</p></div><div className="cat-recovery-meter"><div className="cat-recovery-amount">$3,200</div><div className="cat-recovery-bar"><span style={{ width: "55%" }}></span></div><div className="cat-recovery-bar-label">Base amount</div></div></div>
              <div className="cat-recovery-row accent"><span className="cat-recovery-icon" aria-hidden="true"><svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 4v17M5 21h14" /><path d="M5 8h14" /><path d="M5 8l-2 5h4z M19 8l-2 5h4z" /><path d="M12 4l-7 4M12 4l7 4" /></svg></span><span className="cat-recovery-num" aria-hidden="true">02</span><div className="cat-recovery-label"><span className="cat-recovery-tag accent">Consequential damages</span><p>Lost wages, alternative housing, medical from health impacts.</p></div><div className="cat-recovery-meter"><div className="cat-recovery-amount accent">+$1,400</div><div className="cat-recovery-bar"><span style={{ width: "30%", background: "var(--accent)" }}></span></div><div className="cat-recovery-bar-label">Multiplier</div></div></div>
              <div className="cat-recovery-row"><span className="cat-recovery-icon" aria-hidden="true"><svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="7" width="18" height="13" rx="2" /><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /><path d="M3 12h18" /></svg></span><span className="cat-recovery-num" aria-hidden="true">03</span><div className="cat-recovery-label"><span className="cat-recovery-tag">Filing fee + interest</span><p>Filing fee, service-of-process cost, pre-judgment interest at the state legal rate.</p></div><div className="cat-recovery-meter"><div className="cat-recovery-amount">+$200</div><div className="cat-recovery-bar"><span style={{ width: "5%" }}></span></div><div className="cat-recovery-bar-label">Typical recovery</div></div></div>
            </div>
            <div className="cat-recovery-total"><div className="cat-recovery-total-copy"><span className="eyebrow" style={{ color: "rgba(254,249,241,0.65)" }}>What you walk away with</span><h3>Estimated <em>recovery</em></h3><p>Sample math on a fence damage case. Your numbers will differ.</p></div><div className="cat-recovery-total-note" aria-hidden="true"><span>typical small-claims recovery</span><svg viewBox="0 0 60 40" width="50" height="36" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M5 8 C 20 5, 40 12, 50 30" /><path d="M42 24 L52 32 L46 36" /></svg></div><div className="cat-recovery-total-num">$4,800</div></div>
          </div>
        </section>
          ...
          <div style={{ background: "#0d0d0d", color: "#fff", padding: "32px 0", borderRadius: 20, position: "relative", overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1.85fr 1fr", gap: 0, alignItems: "center" }}>
              ...
              <div style={{ borderLeft: "1px solid #1f1f1f", padding: "20px 44px", position: "relative", alignSelf: "stretch", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                ...
                <div>
                  <div style={{ fontFamily: "Geist, system-ui, sans-serif", fontWeight: 700, fontSize: 14, color: "#fff", marginBottom: 2 }}>Renee P.</div>
                  <div style={{ fontSize: 12.5, color: "#9aa0a6" }}>Homeowner · New York</div>
                </div>
              </div>
            </div>
          </div>
