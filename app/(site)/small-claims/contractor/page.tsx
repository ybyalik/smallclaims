...
const ISSUE_PHOTOS = ["1503387762-592deb58ef4e", "1581094288338-2314dddb7ece", "1556909114-f6e7ad7d3136", "1581244277943-fe4a9c777189", "1567521464027-f127ff144326"];
        ...
        <section className="cat-section">
          ...
          <div className="photo-grid">
            {ISSUES.map((i, idx) => {
              ...
              return i.ready ? (
                <Link key={i.slug} href={`/small-claims/sue-contractor-${i.slug}`} className="photo-card">
                  {inner}
                </Link>
              ) : (
        ...
        <section className="cat-section">
          ...
          <div className="cat-recovery">
            ...
            <div className="cat-recovery-total">
              ...
              <div className="cat-recovery-total-num">$4,200</div>
            </div>
          </div>
        </section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.85fr 1fr", gap: 0, alignItems: "center" }}>
              ...
              <div style={{ borderLeft: "1px solid #1f1f1f", padding: "20px 44px", position: "relative", alignSelf: "stretch", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                ...
                <p style={{ fontFamily: "Newsreader, Georgia, serif", fontSize: 18, fontStyle: "italic", lineHeight: 1.35, letterSpacing: "-0.005em", color: "#fef9f1", margin: "0 0 16px" }}>
                  He took my $4,800 deposit and ghosted. Demand letter alone got the check in seven days.
                </p>
                <div>
                  <div style={{ fontFamily: "Geist, system-ui, sans-serif", fontWeight: 700, fontSize: 14, color: "#fff", marginBottom: 2 }}>Dana W.</div>
                  <div style={{ fontSize: 12.5, color: "#9aa0a6" }}>Homeowner · Florida</div>
                </div>
              </div>
            </div>
          </div>
