...
export default function SectionsPage() {
  return (
    <main style={{ background: "#fff" }}>
      ...
      {/* ============================================================
           11. Stepped framework — copy + step tabs left, photo card with diagram right
           ============================================================ */}
      <Label id="11">Stepped framework — step tabs + CTA left, photo with diagram overlay right</Label>
      <SectionSteppedFramework />
...
/* ─────────────────────────────────────────────────────────────────────
   11. Stepped framework
   ───────────────────────────────────────────────────────────────────── */
function SectionSteppedFramework() {
  return (
    <section style={{ background: "#f1eadc", padding: "32px 24px 96px" }}>
      <div
        style={{
      ...
      >
        {/* LEFT — copy, step tabs, social proof, CTA */}
        <div>
          <h2
            style={{
              fontFamily: "Geist, system-ui, sans-serif",
        ...
        {/* RIGHT — photo card with diagram overlay */}
        <div
          style={{
            background: "#1a1714",
            borderRadius: 22,
        ...
        >
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="https://images.unsplash.com/photo-1593642634315-48f5414c3ad9?w=1100&h=900&fit=crop"
            alt=""
            style={{
              position: "absolute",
              inset: 0,
          ...
          />
          {/* Slight dark veil for text legibility */}
          <div
            style={{
              position: "absolute",
              inset: 0,
          ...
          <div style={{ position: "absolute", top: 32, left: 36, right: 36, color: "#fff", zIndex: 2 }}>
            ...
            >
              We dive deep into your business to tailor solutions that truly fit your goals.
            </p>
          </div>
          ...
          <div style={{ position: "absolute", inset: 0, zIndex: 2 }}>
            ...
            <svg
              ...
              style={{ position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none" }}
            >
              {/* dotted connectors from left labels to gold core */}
              ...
              {/* line from gold core to right pill */}
            ...
            >
              Fast-track to financial<br />clarity
            </div>
          </div>
        </div>
      </div>
