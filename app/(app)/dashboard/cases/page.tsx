    ...
    <div>
      ...
      {list.length === 0 ? (
        <div className="app-empty">
          <h2>No cases yet</h2>
          <p>Start a case to begin building your file. You can purchase a demand letter or other services once you&apos;ve added your details.</p>
          <Link href="/dashboard/cases/new" className="btn btn-dark">
            Start a new case
          </Link>
        </div>
        ...
        <ul className="app-case-list">
          {list.map((c) => {
            ...
            // Drafts go to the builder; everything else opens the case summary.
